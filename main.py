...
def getweather(city):
    ...
    if result:
        ...
        temp = json['main']['temp'] * 9/5 - 459.67  # convert to Fahrenheit
        temp_feels = json['main']['feels_like'] * 9/5 - 459.67  # convert to Fahrenheit
...
if city_name:        
    ...
    st.markdown('created with https://openweathermap.org/api') 
